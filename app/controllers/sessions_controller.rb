class SessionsController < ApplicationController
  ...
  def create
    ...
    if user.visibility == nil
      redirect_to user, notice: "Thanks for joining Dancer City ! We sent a welcome email. Please setup your profile, use a valid email address because all the Dancer City messages are sent by email."
    else
