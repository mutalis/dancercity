class PostsController < ApplicationController
  ...
  def index
    set_meta_tags :title => 'Tango M&eacute;xico',
                  ...
                  :keywords => 'tango, mexico, tango mexico, milonga, milongas, bailar tango, clases de tango, clases tango, musica de tango, musica tango, maestros de baile, programa de radio tango, bailar, baile, danza'
